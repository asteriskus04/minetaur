...
(function (global, factory) { if (typeof module === 'object' && typeof module.exports === 'object') { var wrapper = function (w) { if (!w.document) { throw Error('AnyChart requires a window with a document'); } factory.call(w, w, w.document); try { w.acgraph.isNodeJS = Object.prototype.toString.call(global.process) == "[object process]"; } catch (e) { }; return w.anychart; }; module.exports = global.document ? wrapper(global) : wrapper; } else { factory.call(global, window, document) } })(typeof window !== 'undefined' ? window : this, function (window, document, opt_noGlobal) {
    var $, _, $_ = this.anychart; if ($_ && (_ = $_._)) { $ = $_.$ } else { throw Error('anychart-base.min.js module should be included first. See modules explanation at https://docs.anychart.com/Quick_Start/Modules for details'); $ = {}; _ = {} } if (!_.exports) {
        _.exports = 1; (function ($) {
            ...
            EX = function (a, b) {
                var c = new zX; $.Id(c, "ready", c.cd, !1, c); if (c.zv) throw Error("[goog.net.IframeIo] Unable to send, already active."); var d = new $.mX(a); if (!AX) { AX = $.Ne("FORM"); AX.acceptCharset = "utf-8"; var e = AX.style; e.position = "absolute"; e.visibility = "hidden"; e.top = e.left = "-10px"; e.width = e.height = "10px"; e.overflow = "hidden"; window.document.body.appendChild(AX) } c.qk = AX; b && oga(c.qk, b); c.qk.action = d.toString(); c.qk.method = "POST"; c.zv = !0; c.bA = c.er + "_" + (c.Jga++).toString(36); c.cl = $.te(c.qk).oc("IFRAME", {
                    name: c.bA,
                    id: c.bA
                }); $.hd && 7 > Number($.ad) && (c.cl.src = 'javascript:""'); d = c.cl.style; d.visibility = "hidden"; d.width = d.height = "10px"; d.display = "none"; $.vd ? d.marginTop = d.marginLeft = "-10px" : (d.position = "absolute", d.top = d.left = "-10px"); if ($.hd && !$.bd("11")) { c.qk.target = c.bA || ""; $.te(c.qk).b.body.appendChild(c.cl); $.Id(c.cl, "readystatechange", c.cV, !1, c); try { c.b = !1, c.qk.submit() } catch (Fb) { $.Sd(c.cl, "readystatechange", c.cV, !1, c), BX(c) } } else {
                    $.te(c.qk).b.body.appendChild(c.cl); d = c.bA + "_inner"; e = hX(c.cl); if (window.document.baseURI) {
                        var f =
                            $.pc(d); $.de("Short HTML snippet, input escaped, safe URL, for performance"); f = '<head><base href="' + $.pc(window.document.baseURI) + '"></head><body><iframe id="' + f + '" name="' + f + '"></iframe>'; f = $.pe(f, null)
                    } else f = $.pc(d), $.de("Short HTML snippet, input escaped, for performance"), f = $.pe('<body><iframe id="' + f + '" name="' + f + '"></iframe>', null); $.wf && !$.vd ? e.documentElement.innerHTML = cX(f) : e.write(cX(f)); $.Id(e.getElementById(d), "load", c.LM, !1, c); var h = gX("TEXTAREA", c.qk); f = 0; for (var k = h.length; f < k; f++) {
                        var l =
                            h[f].value; $.lf(h[f]) != l && ($.ef(h[f], l), h[f].value = l)
                    } h = e.importNode(c.qk, !0); h.target = d; h.action = c.qk.action; e.body.appendChild(h); l = gX("SELECT", c.qk); var m = gX("SELECT", h); f = 0; for (k = l.length; f < k; f++)for (var p = gX("OPTION", l[f]), q = gX("OPTION", m[f]), r = 0, t = p.length; r < t; r++)q[r].selected = p[r].selected; l = gX("INPUT", c.qk); m = gX("INPUT", h); f = 0; for (k = l.length; f < k; f++)if ("file" == l[f].type && l[f].value != m[f].value) { c.qk.target = d; h = c.qk; break } try { c.b = !1, h.submit(), e.close(), $.gd && $.zj(c.z4, 250, c) } catch (Fb) {
                        try {
                            var u =
                                $.ha("window.location.href"); if ($.z(Fb)) var v = { message: Fb, name: "Unknown error", lineNumber: "Not available", fileName: u, stack: "Not available" }; else {
                                    f = !1; try { var w = Fb.lineNumber || Fb.line || "Not available" } catch (jc) { w = "Not available", f = !0 } try { var x = Fb.fileName || Fb.filename || Fb.sourceURL || $.fa.$googDebugFname || u } catch (jc) { x = "Not available", f = !0 } v = !f && Fb.lineNumber && Fb.fileName && Fb.stack && Fb.message && Fb.name ? Fb : {
                                        message: Fb.message || "Not available", name: Fb.name || "UnknownError", lineNumber: w, fileName: x, stack: Fb.stack ||
                                            "Not available"
                                    }
                                } var y = v.fileName; null != y || (y = ""); if (/^https?:\/\//i.test(y)) { var B = aX(y); $.de("view-source scheme plus HTTP/HTTPS URL"); var G = "view-source:" + $W(B); var C = $.ge(G) } else { var I = $.de("sanitizedviewsrc"); C = $.ge(VW(I)) } var P = eX("Message: " + v.message + "\nUrl: "); u = { href: C, target: "_new" }; var Q = v.fileName; if (!CX.test("a")) throw Error("Invalid tag name <a>."); if ("A" in pga) throw Error("Tag name <a> is not allowed for SafeHtml."); w = null; x = ""; if (u) for (var S in u) {
                                    if (!CX.test(S)) throw Error('Invalid attribute name "' +
                                        S + '".'); var ua = u[S]; if (null != ua) {
                                            C = x; y = S; B = ua; if (B instanceof $.ce) B = VW(B); else if ("style" == y.toLowerCase()) B = ega(B); else { if (/^on/i.test(y)) throw Error('Attribute "' + y + '" requires goog.string.Const value, "' + B + '" given.'); if (y.toLowerCase() in qga) if (B instanceof ZW) B = Zfa(B); else if (B instanceof $.fe) B = $W(B); else if ($.z(B)) B = aX(B).Et(); else throw Error('Attribute "' + y + '" on tag "a" requires goog.html.SafeUrl, goog.string.Const, or string, value "' + B + '" given.'); } B.Rx && (B = B.Et()); var xa = y + '="' + $.pc(String(B)) +
                                                '"'; x = C + (" " + xa)
                                        }
                                } var Qa = "<a" + x; null != Q ? $.A(Q) || (Q = [Q]) : Q = []; if (!0 === rga.a) Qa += ">"; else { var ub = fX(Q); Qa += ">" + cX(ub) + "</a>"; w = ub.Bx() } var nc = u && u.dir; nc && (/^(ltr|rtl|auto)$/i.test(nc) ? w = 0 : w = null); var ib = $.pe(Qa, w); var Nb = fX(P, ib, eX("\nLine: " + v.lineNumber + "\n\nBrowser stack:\n" + v.stack + "-> [end]\n\nJS stack traversal:\n" + UW(void 0) + "-> "))
                        } catch (jc) { Nb = eX("Exception trying to expose exception! You win, we lose. " + jc) } cX(Nb); $.Sd(e.getElementById(d), "load", c.LM, !1, c); e.close(); BX(c)
                    }
                } DX(c)
            };
            ...
            tga = function (a, b, c, d, e) {
                if (a.b) throw Error("[goog.net.XhrIo] Object is active with another request=" + a.ka + "; newUri=" + b); c = c ? c.toUpperCase() : "GET"; a.ka = b; a.D = ""; a.g = 0; a.ga = !1; a.f = !0; a.b = a.ca ? PX(a.ca) : PX(TX); a.U = a.ca ? LX(a.ca) : LX(TX); a.b.onreadystatechange = (0, $.pa)(a.B2, a); try { a.ua = !0, a.b.open(c, String(b), !0), a.ua = !1 } catch (h) { a.jv(5, h); return } b = d || ""; var f = a.headers.clone(); e && lX(e, function (a, b) { f.set(b, a) }); e = $.ya(f.At(), uga); d = $.fa.FormData && b instanceof $.fa.FormData; !$.Aa(vga, c) || e || d || f.set("Content-Type",
                    "application/x-www-form-urlencoded;charset=utf-8"); f.forEach(function (a, b) { this.b.setRequestHeader(b, a) }, a); a.Na && (a.b.responseType = a.Na); "withCredentials" in a.b && a.b.withCredentials !== a.Ja && (a.b.withCredentials = a.Ja); try { UX(a), 0 < a.G && (a.Ga = wga(a.b), a.Ga ? (a.b.timeout = a.G, a.b.ontimeout = (0, $.pa)(a.G4, a)) : a.O = $.zj(a.G4, a.G, a)), a.N = !0, a.b.send(b), a.N = !1 } catch (h) { a.jv(5, h) }
            }; wga = function (a) { return $.hd && $.bd(9) && $.ea(a.timeout) && $.n(a.ontimeout) }; uga = function (a) { return "content-type" == a.toLowerCase() };
            ...
            jY = function (a, b, c, d, e, f, h) {
                var k = null; $.n(c) ? $.ea(c) ? (b["pdf-width"] = c, b["pdf-height"] = $.ea(d) ? d : a.height()) : $.z(c) ? (b["pdf-size"] = c || "a4", b.landscape = !!d, k = iY[b["pdf-size"]], b.landscape && (k = { width: k.height, height: k.width })) : (b["pdf-width"] = a.width(), b["pdf-height"] = a.height()) : (b["pdf-width"] = a.width(), b["pdf-height"] = a.height()); $.n(e) && (b["pdf-x"] = e); $.n(f) && (b["pdf-y"] = f); $.n(h) && (b["file-name"] = h); k ? (c = k.width, k = k.height, d = a.width(), h = a.height(), k = c < k ? [c, c / d * h] : c > k ? [k / h * d, k] : [c, k], k[0] -= e || 0,
                    k[1] -= f || 0, a = a.pq(k[0], k[1])) : a = a.pq(b["pdf-width"], b["pdf-height"]); b.data = a; b.dataType = "svg"; b.responseType = "file"
            }; kY = function (a) { var b = ""; a && (b = (new window.XMLSerializer).serializeToString(a)); return b }; lY = function () { this.b = {}; this.f = {}; this.D = {}; this.g = {}; this.j = {}; this.O = ["svg2pdf.min.js", "jspdf.min.js", "canvg.min.js"]; this.WL = !1; this.G = { path: "https://cdn.anychart.com/3rd/", enabled: !0, fallback: !0 } };
            ...
            oY = function (a, b, c, d) {
                var e = c.paperSize, f = c.landscape, h = c.x || 0, k = c.y || 0, l = c.filename || "anychart"; l += ".pdf"; try {
                    if ($.n(e) || $.n(f)) { var m = LW(e, f); if ($.z(e)) { var p = iY[e].width; var q = iY[e].height; if (f && q > p || !f && q < p) p = [q, q = p][0] } else p = (0, window.parseFloat)(m.width), q = (0, window.parseFloat)(m.height); var r = new $.fa.jsPDF(f ? "l" : "p", "pt", e || [p, q]); $.z(b) ? r.addImage(b, "png", h, k, p, q) : $.fa.svg2pdf(b, r, { xOffset: h, yOffset: k, scale: 1 }) } else {
            ...
            pY = function (a, b, c, d, e, f, h) {
                switch (c) { case "jpg": var k = "image/jpeg"; break; default: c = "png", k = "image/png" }var l = $.Se(window.document, "canvas"); l.width = d; l.height = e; $.uf(l, { width: d, height: e, visibility: "hidden", position: "fixed", right: 0, bottom: 0 }); $.Ap.body.appendChild(l); var m = l.getContext("2d"), p = new window.Image, q = b.quality || .92; a.setAttribute("width", d); a.setAttribute("height", e); var r = (new window.XMLSerializer).serializeToString(a), t = XW(new window.Blob([r], { type: "image/svg+xml" })); p.onload = function () {
                    try {
                        if (l.msToBlob &&
                            m.drawSvg) { m.drawSvg(r, 0, 0, d, e); var a = l.toDataURL(k, q) } else m.drawImage(p, 0, 0, d, e), a = l.toDataURL(k, q); f(a); $.Xe(l); WW().revokeObjectURL(t)
                    } catch (v) { h(b) }
                }; p.src = t
            };
            ...
            var $fa = /^(?:(?:https?|mailto|ftp):|[^:/?#]*(?:[/?#]|$))/i, cga = /^[-,."'%_!# a-zA-Z0-9]+$/, CX = /^[a-zA-Z0-9-]+$/, qga = { action: !0, cite: !0, data: !0, formaction: !0, href: !0, manifest: !0, poster: !0, src: !0 }, pga = { APPLET: !0, BASE: !0, EMBED: !0, IFRAME: !0, LINK: !0, MATH: !0, META: !0, OBJECT: !0, SCRIPT: !0, STYLE: !0, SVG: !0, TEMPLATE: !0 }, iY = {
            ...
            mY.PD = function (a, b, c, d, e, f) {
                var h = mY.uc(a, "facebook"), k = iX({ caption: c, link: d, name: e, description: f }, c, h), l = $.el.open("", "_blank", "scrollbars=yes, width=550, height=550, top=" + Number(window.screen.height / 2 - 275) + ", left=" + Number(window.screen.width / 2 - 275)); mY.iu(a, b, function (a) {
            ...
            mY.SD = function (a, b) {
                var c = mY.uc(a, "twitter"), d = Number(window.screen.width / 2 - 300), e = Number(window.screen.height / 2 - 260); var f = $.Be(window.document, "INPUT", "ac-share-twitter-data-input", void 0); if (0 < f.length) { var h = f[0]; f = $.Be(window.document, "FORM", "ac-share-twitter-form", void 0)[0] } else {
                    f = $.Se(window.document, "FORM"); $.Nj(f, "ac-share-twitter-form"); f.target = "Map"; f.method = "POST"; f.action = c.url; h = $.Se(window.document, "INPUT"); $.Nj(h, "ac-share-twitter-data-input"); h.type = "hidden"; h.name = "data"; var k =
                        $.Se(window.document, "INPUT"); k.type = "hidden"; k.name = "dataType"; k.value = "svg"; f.appendChild(h); f.appendChild(k); gX("BODY")[0].appendChild(f)
    ...
    if (!_.data_adapter) {
        _.data_adapter = 1; (function ($) {
            ...
            $.F("anychart.data.parseHtmlTable", function (a, b, c, d, e, f) {
                var h = window.document.querySelector(a || "table"); a = null; var k; if (h) {
                    d = d || "tr:first-child th"; c = c || "td, th"; b = b || "tr"; a = {}; (e = h.querySelector(e || "caption")) && (k = f ? f.call(void 0, e) : e.innerText); k && (a.title = k); var l = h.querySelectorAll(d), m = []; e = null; d = 0; for (k = l.length; d < k; d++) { var p = l[d]; p && !e && (e = $.cf(p)); m.push(f ? f.call(void 0, p) : p.innerText) } m.length && (a.header = m); if ((b = h.querySelectorAll(b)) && b.length) {
                        h = []; d = 0; for (k = b.length; d < k; d++)if (m = b[d],
                            m != e) { l = []; if ((m = m.querySelectorAll(c)) && m.length) { p = 0; for (var q = m.length; p < q; p++) { var r = m[p]; f ? l.push(f.call(void 0, r)) : l.push(r.innerText) } } l.length && h.push(l) } a.rows = h
                    }
                } return a
            }); $.F("anychart.data.loadJsonFile", function (a, b, c, d, e, f, h, k, l) { b = (0, $.pa)(yY, void 0, Dga, b, c, l); $.SX(a, b, d, e, f, h, k) }); $.F("anychart.data.loadXmlFile", function (a, b, c, d, e, f, h, k, l) { b = (0, $.pa)(yY, void 0, Ega, b, c, l); $.SX(a, b, d, e, f, h, k) });
            $.F("anychart.data.loadCsvFile", function (a, b, c, d, e, f, h, k, l) { b = (0, $.pa)(yY, void 0, Gga, b, c, l); $.SX(a, b, d, e, f, h, k) });
            $.F("anychart.data.loadGoogleSpreadsheet", function (a, b, c, d, e) { b = (0, $.pa)(yY, void 0, Fga, b, c, e); $.z(a) ? (c = a, a = "od6") : (c = a.key, a = $.n(a.sheet) ? a.sheet : "od6"); a = new $.mX("https://spreadsheets.google.com/feeds/cells/" + c + "/" + a + "/public/values"); a.g.set("alt", "json"); c = Math.floor(2147483648 * Math.random()).toString(36) + Math.abs(Math.floor(2147483648 * Math.random()) ^ (0, $.En)()).toString(36); a.g.set("zx", c); $.SX(a.toString(), b, "GET", null, null, d) });
        }).call(this, $)
    }
